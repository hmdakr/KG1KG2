...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mcFinal).wait(143));
	...
	// box3
	this.instance_1 = new lib.box3_5();
	this.instance_1.setTransform(1087,208.65);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(77).to({_off:false},0).to({x:237},13,cjs.Ease.get(1)).to({x:247},5,cjs.Ease.get(1)).to({_off:true},7).wait(1).to({_off:false},0).wait(40));

	// box2
	this.instance_2 = new lib.box2_5();
	this.instance_2.setTransform(822,208.65);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(74).to({_off:false},0).to({x:-28},13,cjs.Ease.get(1)).to({x:-18},5,cjs.Ease.get(1)).to({_off:true},10).wait(1).to({_off:false},0).wait(40));

	// box
	this.instance_3 = new lib.box_5();
	this.instance_3.setTransform(547,208.65);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(71).to({_off:false},0).to({x:-303},13,cjs.Ease.get(1)).to({x:-293},5,cjs.Ease.get(1)).to({_off:true},13).wait(1).to({_off:false},0).wait(40));

	// _
	this.instance_4 = new lib.Goat();
	this.instance_4.setTransform(-626,-20.7,1.4,1.4);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(51).to({_off:false},0).to({x:10},12,cjs.Ease.get(1)).to({x:0},6,cjs.Ease.get(1)).wait(74));

	// box3
	this.instance_5 = new lib.box3_4();
	this.instance_5.setTransform(247,208.65);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:257},5,cjs.Ease.get(1)).to({x:-553},10,cjs.Ease.get(1)).to({_off:true},1).wait(108));

	// box2
	this.instance_6 = new lib.box2_4();
	this.instance_6.setTransform(-18,208.65);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(17).to({x:-8},5,cjs.Ease.get(1)).to({x:-818},10,cjs.Ease.get(1)).to({_off:true},1).wait(110));

	// box
	this.instance_7 = new lib.box_4();
	this.instance_7.setTransform(-293,208.65);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(15).to({x:-283},5,cjs.Ease.get(1)).to({x:-1093},10,cjs.Ease.get(1)).to({_off:true},1).wait(112));

	// doll01
	this.instance_8 = new lib.doll01("synched",0);
	this.instance_8.setTransform(-344.05,-9.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(17).to({startPosition:0},0).to({x:-354.05},6,cjs.Ease.get(1)).to({x:575.95},13,cjs.Ease.get(1)).to({_off:true},1).wait(106));

	// doll01
	this.instance_9 = new lib.doll01("synched",0);
	this.instance_9.setTransform(-187.55,-9.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(15).to({startPosition:0},0).to({x:-197.55},6,cjs.Ease.get(1)).to({x:732.45},13,cjs.Ease.get(1)).to({_off:true},1).wait(108));

	// doll01
	this.instance_10 = new lib.doll01("synched",0);
	this.instance_10.setTransform(-31.05,-9.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(13).to({startPosition:0},0).to({x:-41.05},6,cjs.Ease.get(1)).to({x:888.95},13,cjs.Ease.get(1)).to({_off:true},1).wait(110));

	// doll01
	this.instance_11 = new lib.doll01("synched",0);
	this.instance_11.setTransform(125.45,-9.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(11).to({startPosition:0},0).to({x:115.45},6,cjs.Ease.get(1)).to({x:1045.45},13,cjs.Ease.get(1)).to({_off:true},1).wait(112));

	// doll01
	this.instance_12 = new lib.doll01("synched",0);
	this.instance_12.setTransform(281.95,-9.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(9).to({startPosition:0},0).to({x:271.95},6,cjs.Ease.get(1)).to({x:1201.95},13,cjs.Ease.get(1)).to({_off:true},1).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(143));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1151,-302.4,2431,605);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mcFinal).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(93));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mcFinal).wait(95));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mcFinal).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({x:-342.85},11,cjs.Ease.get(1)).wait(131));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(54).to({_off:false},0).to({x:237},13,cjs.Ease.get(1)).to({x:247},5,cjs.Ease.get(1)).to({_off:true},73).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(51).to({_off:false},0).to({x:-28},13,cjs.Ease.get(1)).to({x:-18},5,cjs.Ease.get(1)).to({_off:true},76).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(48).to({_off:false},0).to({x:-303},13,cjs.Ease.get(1)).to({x:-293},5,cjs.Ease.get(1)).to({_off:true},79).wait(1));

	// umbrella
	this.instance_4 = new lib.umbrella("synched",0);
	this.instance_4.setTransform(-1009.85,-21.85,1,1,0,0,0,0.1,-0.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(35).to({_off:false},0).to({x:-159.85},13,cjs.Ease.get(1)).to({x:-169.85},6,cjs.Ease.get(1)).wait(92));

	// umbrella
	this.instance_5 = new lib.umbrella("synched",0);
	this.instance_5.setTransform(-659.85,-21.85,1,1,0,0,0,0.1,-0.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(30).to({_off:false},0).to({x:190.15},13,cjs.Ease.get(1)).to({x:180.15},6,cjs.Ease.get(1)).wait(97));

	// Layer_44
	this.instance_6 = new lib.text01("synched",0);
	this.instance_6.setTransform(938,-223.95);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).to({x:-22},12,cjs.Ease.get(1)).to({x:-12},6,cjs.Ease.get(1)).wait(116));

	// bg
	this.instance_7 = new lib.gh();
	this.instance_7.setTransform(3.4,4.1);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({alpha:1},12).wait(134));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1159.9,-302.4,2534.9,605);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Interface_atlas_1.png?1637855057602", id:"Interface_atlas_1"}
	],
	preloads: []
};
